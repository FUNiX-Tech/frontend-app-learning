...
const messages = defineMessages({
  allDates: {
    ...
    description:
      "Text anchor for link that redirects to dates or course timeline tab",
  },
  ...
  casualGoalButtonTitle: {
    ...
    description:
      "A very short description of the least intense of three learning goals",
  },
  certAlt: {
    id: "learning.outline.certificateAlt",
    defaultMessage: "Example Certificate",
    description:
      "Alternate text displayed when the example certificate image cannot be displayed.",
  },
  collapseAll: {
  ...
  completedAssignment: {
    ...
    description:
      "Text used to describe the green checkmark icon in front of an assignment title",
  },
  completedSection: {
    id: "learning.outline.completedSection",
    defaultMessage: "Completed section",
    description:
      "Text used to describe the green checkmark icon in front of a section title",
  },
  dates: {
    id: "learning.outline.dates",
    defaultMessage: "Important dates",
    description:
      "Headline for the (summary of dates) section of the outline page",
  },
  editGoal: {
  ...
  goalReminderDetail: {
    ...
    defaultMessage:
      "If we notice you’re not quite at your goal, we’ll send you an email reminder.",
  ...
  incompleteAssignment: {
    ...
    description:
      "Text used to describe the gray checkmark icon in front of an assignment title",
  },
  incompleteSection: {
    id: "learning.outline.incompleteSection",
    defaultMessage: "Incomplete section",
    description:
      "Text used to describe the gray checkmark icon in front of a section title",
  },
  ...
  setGoal: {
    ...
    defaultMessage:
      "To start, set a course goal by selecting the option below that best describes your learning plan.",
    description:
      "In indicate to learner how to set or use the goal reminder service",
  },
  setGoalReminder: {
    id: "learning.outline.setGoalReminder",
    defaultMessage: "Set a goal reminder",
    description:
      "The text for the radio button which activate or deactivate the goal reminder service",
  },
  setLearningGoalButtonScreenReaderText: {
    id: "learning.outline.goalButton.casual.title",
    defaultMessage: "Set a learning goal style.",
    description:
      "screen reader text informing learner they can select an intensity of learning goal",
  },
  setWeeklyGoal: {
    id: "learning.outline.setWeeklyGoal",
    defaultMessage: "Set a weekly learning goal",
    description:
      "The headline for (goal reminder service) section in course outline",
  },
  setWeeklyGoalDetail: {
    ...
    description:
      "It indiacate the gaol or the purpose of the goal reminder service to learners",
  },
  start: {
  ...
  courseContentTitle: {
    id: "learning.outline.courseContentTitle",
  ...
  notStartedProctoringStatus: {
    ...
    description:
      "It indcate that proctortrack onboarding exam hasn’t started yet",
  },
  startedProctoringStatus: {
    id: "learning.proctoringPanel.status.started",
    defaultMessage: "Started",
    description:
      "Label to indicate the starting status of the proctortrack onboarding exam",
  },
  submittedProctoringStatus: {
    id: "learning.proctoringPanel.status.submitted",
    defaultMessage: "Submitted",
    description:
      "Label to indicate the submitted status of proctortrack onboarding exam",
  },
  verifiedProctoringStatus: {
    id: "learning.proctoringPanel.status.verified",
    defaultMessage: "Verified",
    description:
      "Label to indicate the verified status of the proctortrack onboarding exam",
  },
  rejectedProctoringStatus: {
    id: "learning.proctoringPanel.status.rejected",
    defaultMessage: "Rejected",
    description:
      "Label to indicate the rejection status of the proctortrack onboarding exam",
  },
  errorProctoringStatus: {
    id: "learning.proctoringPanel.status.error",
    defaultMessage: "Error",
    description:
      "Label to indicate that there is error in proctortrack onboarding exam",
  },
  ...
  expiringSoonProctoringStatus: {
    ...
    description:
      "A label to indicate that proctortrack onboarding exam will expire soon",
  },
  expiredProctoringStatus: {
    id: "learning.proctoringPanel.status.expired",
    defaultMessage: "Expired",
    description:
      "A label to indicate that proctortrack onboarding exam has expired",
  },
  proctoringCurrentStatus: {
    id: "learning.proctoringPanel.status",
    defaultMessage: "Current Onboarding Status:",
    description:
      "The text that precede the status label of proctortrack onboarding exam",
  },
  notStartedProctoringMessage: {
    ...
    description:
      "The text that explain the meaning of (not started) label of the proctortrack onboarding exam",
  },
  startedProctoringMessage: {
    id: "learning.proctoringPanel.message.started",
    defaultMessage: "You have started your onboarding exam.",
    description:
      "The text that explain the meaning of (started) label of the proctortrack onboarding exam",
  },
  submittedProctoringMessage: {
    ...
    description:
      "The text that explain the meaning of (submitted) label of the proctortrack onboarding exam",
  },
  verifiedProctoringMessage: {
    ...
    description:
      "The text that explain the meaning of (verified) label of the proctortrack onboarding exam",
  },
  rejectedProctoringMessage: {
    id: "learning.proctoringPanel.message.rejected",
    defaultMessage:
      "Your onboarding exam has been rejected. Please retry onboarding.",
    description:
      "The text that explain the meaning of (rejected) label of the proctortrack onboarding exam",
  },
  errorProctoringMessage: {
    ...
    description:
      "The text that explain the meaning of (error) label of the proctortrack onboarding exam",
  },
  ...
  otherCourseApprovedProctoringDetail: {
    ...
    defaultMessage:
      "If your device has changed, we recommend that you complete this course's onboarding exam in order to ensure that your setup still meets the requirements for proctoring.",
    description:
  ...
  expiringSoonProctoringMessage: {
    ...
    defaultMessage:
      "Your onboarding profile has been approved. However, your onboarding status is expiring soon. Please complete onboarding again to ensure that you will be able to continue taking proctored exams.",
    description:
  ...
  expiredProctoringMessage: {
    ...
    defaultMessage:
      "Your onboarding status has expired. Please complete onboarding again to continue taking proctored exams.",
    description:
  ...
  proctoringPanelGeneralInfo: {
    ...
    defaultMessage:
      "You must complete the onboarding process prior to taking any proctored exam. ",
    description:
  ...
  proctoringPanelGeneralInfoSubmitted: {
    ...
    description:
      "The text that explain the meaning of (in review) label of the proctortrack onboarding exam",
  },
  ...
  proctoringOnboardingButton: {
    ...
    description:
      "Text shown on the button that starts the actual proctortrack onboarding exam when it is released",
  },
  ...
  proctoringOnboardingButtonNotOpen: {
    ...
    description:
      "It indicate when or from when the learner can take the proctortrack onboarding exam",
  },
